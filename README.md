...
- 📈 Keen on joining innovative teams to develop high-performance SaaS and eCommerce platforms
...
**Data Quality Intern**  
*Saras Analytics, Hyderabad (Aug 2022 – Jan 2023)*  
- Wrote advanced SQL queries and built analytical dashboards for e-commerce clients  
- Extracted Google Analytics data and automated Excel reporting using VBA  
- Delivered 30% efficiency boost through process automation

---

## 🚀 Projects

### 🔹 Smart Competency Project (Sep 2024 – Mar 2025)
- Built an AI-powered job-matching and learning recommendation platform  
- Used machine learning to identify skill gaps and suggest training paths  
- Developed adaptive micro-courses and resume automation tools  
- Implemented scalable Django backend and REST APIs for real-time insights
...
Vasireddy Venkatadri Institute of Technology, India — *CGPA 7.5/10*  

**Diploma - Computer Engineering**  
Chalapathi Institute of Technology — *74%*
